...
public class WetLightBlueSpongeBlock extends WetSpongeBlock {
    public WetLightBlueSpongeBlock(Properties properties) {
        super(properties);
    }
    ...
    protected void onPlace(BlockState state, Level level, BlockPos pos, BlockState oldState, boolean isMoving) {
        if (level.dimensionType().ultraWarm()) {
            level.setBlock(pos, ModBlocks.LIGHT_BLUE_SPONGE_BLOCK.get().defaultBlockState(), 3);
