...
public class WetWhiteSpongeBlock extends WetSpongeBlock {
    public WetWhiteSpongeBlock(Properties properties) {
        super(properties);
    }
    ...
    protected void onPlace(BlockState state, Level level, BlockPos pos, BlockState oldState, boolean isMoving) {
        if (level.dimensionType().ultraWarm()) {
            level.setBlock(pos, ModBlocks.WHITE_SPONGE_BLOCK.get().defaultBlockState(), 3);
