...
public class WetRedSpongeBlock extends WetSpongeBlock {
    public WetRedSpongeBlock(Properties properties) {
        super(properties);
    }
    ...
    protected void onPlace(BlockState state, Level level, BlockPos pos, BlockState oldState, boolean isMoving) {
        if (level.dimensionType().ultraWarm()) {
            level.setBlock(pos, ModBlocks.RED_SPONGE_BLOCK.get().defaultBlockState(), 3);
