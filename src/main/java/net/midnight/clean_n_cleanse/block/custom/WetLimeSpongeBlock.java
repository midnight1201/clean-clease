...
public class WetLimeSpongeBlock extends WetSpongeBlock {
    public WetLimeSpongeBlock(Properties properties) {
        super(properties);
    }
    ...
    protected void onPlace(BlockState state, Level level, BlockPos pos, BlockState oldState, boolean isMoving) {
        if (level.dimensionType().ultraWarm()) {
            level.setBlock(pos, ModBlocks.LIME_SPONGE_BLOCK.get().defaultBlockState(), 3);
